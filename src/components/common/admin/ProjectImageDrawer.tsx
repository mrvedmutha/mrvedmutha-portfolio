...
export default function ProjectImageDrawer({
  value,
  onChange,
  trigger,
}: {
  ...
  const handleUpload = async () => {
    ...
    const res = await axios.post("/api/v1/admin/media/upload-project", formData, {
  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent>
        <DrawerHeader>
          <DrawerTitle>Select or Upload Project Image</DrawerTitle>
        </DrawerHeader>
