...
export default function ContactUsForm() {
  ...
  return (
    <div className="w-full mx-auto">
      <div className="bg-brand-green rounded-xl p-8 lg:p-12 shadow-xl">
        {/* Header Section */}
        <div className="mb-8">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormItem>
                    ...
                    <Popover open={budgetOpen} onOpenChange={setBudgetOpen}>
                      <PopoverTrigger asChild>
                        ...
                        >
                          {field.value
                            ? budgetRanges.find((budget) => budget.value === field.value)?.label
                            : "Enter Range"}
                          <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                        </Button>
                      </PopoverTrigger>
                        ...
                        <Command>
                          <CommandGroup>
                            <CommandList>
                              <CommandItem
                                value="USD"
                                onSelect={() => field.onChange("USD")}
                              >
                                <Check
                                  className={cn(
                                    "mr-2 h-4 w-4",
                                    field.value === "USD" ? "opacity-100" : "opacity-0"
                                  )}
                                />
                                USD
                              </CommandItem>
                              <CommandItem
                                value="INR"
                                onSelect={() => field.onChange("INR")}
                              >
                                <Check
                                  className={cn(
                                    "mr-2 h-4 w-4",
                                    field.value === "INR" ? "opacity-100" : "opacity-0"
                                  )}
                                />
                                INR
                              </CommandItem>
            ...
            <Button
              type="submit"
              disabled={loading}
              className="bg-brand-yellow text-brand-green hover:bg-brand-yellow/90 font-semibold py-3 px-8 rounded-lg flex items-center gap-2 transition-colors"
            >
